...
@app_annotate.route('/annotator')
def annotator():
    return flask.render_template('annotator.html')


@app_annotate.route('/roi', methods=['POST'])
def roi():
...
@app_annotate.route('/image/dimensions/<patient_id>')
...
@app_annotate.route('/image/axial/<patient_id>/<int:slice_i>')
...
@app_annotate.route('/image/axial_mip/<patient_id>/<int:slice_i>')
...
@app_annotate.route('/image/sagittal/<patient_id>/<int:slice_k>')
...
@app_annotate.route('/image/coronal/<patient_id>/<int:slice_j>')
def coronal(patient_id, slice_j):
    arr = _retrieve_arr(patient_id)
    return _send_slice(arr[:, slice_j, :])


@app_annotate.route('/image/rendering/<patient_id>')
