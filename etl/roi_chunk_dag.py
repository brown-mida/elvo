"""
Creates a Directed Acyclic Graph (DAG) to convert 3D CTA data into 32x32x32 chunks,
perform data augmentation on on the positives, and upload the new data and labels
