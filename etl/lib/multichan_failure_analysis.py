"""
Purpose: Manually analyze the false negative cases generated by our current best
Resnet-50 model. Images are generate using the same code as multichannel_mip.py.
"""
